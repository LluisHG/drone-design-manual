...
\titol{Inductive Energy Transfer System based on Drone}

%% Titol del document en anglès (Per l'apartat overview)
\titolE{Inductive Energy Transfer System based on Drone}

%% Titol del document en catala/castella (Per l'apartat resum)
\titolC{Sistema Inductivo de Transferencia de Energía basado en Drone}
...
%%        noms dels autors
\autor{Lluís Hontecillas \and Ignacio Izquierdo}
